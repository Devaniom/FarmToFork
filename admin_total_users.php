...
if(isset($_GET['delete'])){
   ...
   header('location:admin_total_users.php');
...
<head>
   ...
   <title>FarmToFork | Total Users</title>
...
<section class="user-accounts">
   ...
   <div class="box-container">
      ...
      <div class="box" style="<?php if($fetch_users['id'] == $admin_id){ echo 'display:none'; }; ?>">
         ...
         <a href="admin_total_users.php?delete=<?= $fetch_users['id']; ?>" onclick="return confirm('delete this user?');" class="delete-btn">delete</a>
      </div>
      <?php
      }
      ?>
